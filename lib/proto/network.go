...
type NetworkCookie struct {
	...
	// PartitionKey *NetworkCookiePartitionKey `json:"partitionKey,omitempty"` // TODO(PrismAIO): figure out the correct type
...
type NetworkResponseReceivedExtraInfo struct {
	...
	// CookiePartitionKey *NetworkCookiePartitionKey `json:"cookiePartitionKey,omitempty"` // TODO(PrismAIO): figure out the correct type
